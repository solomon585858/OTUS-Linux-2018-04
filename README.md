...
## Homework 6
 ...
 - На виртуальной машине **nfsserver** директория **var/nfs** была добавлена в **etc/exports** с указанием сети доступа клиент и правами на запись
 ...
 - На виртуальной машине **nfsclient** в  **etc/fstab** были прописаны настройки монтирования папки с **NFS** сервера при запуске системы
