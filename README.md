...
#### В процессе сделано:
 ...
 - На виртуальной машине **log** был настроен **rsyslog** сервер, настроен и открыт **514** для **TCP** и **UDP**, а также добавлен шаблон, который для всех логов клиентов создает отдельную папку в **var/log/** с соответствующим **HOSTNAME**, внутри которой создает файлы логов для соответствующих программ.
